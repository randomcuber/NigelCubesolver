...
public class OpenCvRaspberryPiCamera implements CubeColorInspector{
    ...
    public char[][] inspectBackFace(char center) {
        ...
        return new char[][]{//returns a 2 dimensional array of the colors of the back face
                ...
                {
                        findColor(950+offsetX,1160+offsetY,88,249),
                        center,
                        findColor(1536+offsetX,690+offsetY,290,264)
                },
                {
                        findColor(849+offsetX,1600+offsetY,144,320),
                        findColor(1116+offsetX,1460+offsetY,234,324),
                        findColor(1480+offsetX,1250+offsetY,300,500)
                },
        };
    }
    ...
    public char[][] inspectLeftFace(char center) {
        ...
        return new char[][]{
                {
                        findColor(2081+offsetX,350+offsetY,128,100),
                        findColor(2364+offsetX,530+offsetY,100,135),
                        findColor(2620+offsetX,0+offsetY,70,100),
                },
                {
                        findColor(2000+offsetX,675+offsetY,225,170),
                        center,
                        findColor(2690+offsetX,1111+offsetY,100,250)
                },
                {
    ...
    public char[][] inspectDownFace(char center) {
        ...
        return new char[][]{
                {
                        findColor(2520+offsetX,2036+offsetY,250,75),
                        findColor(2055+offsetX,2150+offsetY,185,65),
                        findColor(1940+offsetX,2235+offsetY,70,25),
                },
                {
                        findColor(2165+offsetX,1900+offsetY,375,108),
                        center,
                        findColor(1400+offsetX,2155+offsetY,180,60)
                },
                {
                        findColor(1750+offsetX,1650+offsetY,410,220),
                        findColor(1230+offsetX,1830+offsetY,320,160),
                        findColor(850+offsetX,2050+offsetY,350,60)
                },
        };
    }
